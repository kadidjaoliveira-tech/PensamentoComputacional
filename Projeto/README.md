Exemplo de README.md para usar como guia para postar o projeto no GitHub.

Ele segue boas práticas de documentação e está alinhado à proposta de aprendizagem baseada em projeto (PBL):
